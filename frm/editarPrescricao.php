...
<?php if (isset($_SESSION['PERMISSOES']['editarPrescricao'])) {

    $prescricao = new \Classe\Prescricao();
    $receituario = new \Classe\Receituario();

    if ($_POST['codPrescricao']) {
        $prescricao->setCodPrescricao($_POST['codPrescricao']);
        $prescricao->carregar();

        $receituario->setCodReceituario($prescricao->getCodReceituario());
    ...
    <script type="text/javascript">
        $().ready(function () {
            ...
            $('#editarPrescricaoGerarGPT').click(function () {
                editarPrescricao(2);
            });
            $('#editarPrescricaoEditarOutra').click(function () {
                editarPrescricao(3);
            });

            function editarPrescricao(tipo = 1) {
                overlayStart();
                $.ajax({
                    method: 'POST',
                    url: "php/editarPrescricao.php",
                    data: {
                        cboPrescricao: $('#cboPrescricao').val(),
            ...
            var posologia = "<?=$prescricao->getPosologia();?>";
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="box-title"> Editar Prescrição</h4>
                </div>
                <div class="card-body card-block">
                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <input name="cboPrescricao" type="hidden" id="cboPrescricao"
                               value="<?= $prescricao->getCodPrescricao(); ?>">
                        <input name="cboReceituario" type="hidden" id="cboReceituario"
                               value="<?= $receituario->getCodReceituario(); ?>">
                        <div class="row form-group">
                            <div class="col col-6 col-md-6">
                                ...
                                echo $comboMedicamento->combo($prescricao->getCodMedicamento(), 'cboMedicamento', '');
                                ?>
                            </div>
                            <div class="col col-6 col-md-6">
                                ...
                                echo $comboViaAdministracao->combo($prescricao->getCodViaAdministracao(), 'cboViaAdministracao', '');
                                ?>
                            </div>
                            <div class="col col-6 col-md-6">
                                ...
                                <input type='number' class='form-control' id='txtQuantidadeDose'
                                       ...
                                       placeholder='' value='<?= $prescricao->getQuantidadeDose(); ?>'/>
                            </div>
                            <div class="col col-6 col-md-6">
                                ...
                                echo $comboUnidadeMedida->combo($prescricao->getCodUnidadeMedida(), 'cboUnidadeMedida', '');
                                ?>
                            </div>
                        </div>
                        <div class="col col-6 col-md-6">
                            ...
                            <div class="col col-6 col-md-6">
                                <div class="row form-group">
                                    <div class="col col-6 col-md-6">
                                        ...
                                        <div id="posologia"><?= $prescricao->getPosologia(); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-4 col-md-4">
                                ...
                                <input type='date' class='form-control' id='txtInicioTratamento'
                                       name='txtInicioTratamento' placeholder=''
                                       value='<?= $prescricao->getInicioTratamento(); ?>'/>
                            </div>
                            <div class="col col-4 col-md-4">
                            ...
                            <div class="col col-12 col-md-12">
                                ...
                                <input type='date' class='form-control' id='txtConclusaoTratamento'
                                       ...
                                       placeholder='' value='<?= $prescricao->getConclusaoTratamento(); ?>'/>
                            </div>
                            <div class="col col-12 col-md-12">
                                ...
                                <input type='number' class='form-control' id='txtQuantidadeSolicitada'
                                       ...
                                       placeholder='' value='<?= $prescricao->getQuantidadeSolicitada() ?>'/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
                                <button type="submit" class="btn btn-primary btn-block btn-sm" id="editarPrescricao"
                                        name="editarPrescricao">Salvar Prescrição
                                </button>
                            </div>
                            <div class="col-sm-4">
                                <button type="submit" class="btn btn-primary btn-block btn-sm"
                                        id="editarPrescricaoGerarGPT"
                                        name="editarPrescricaoGerarGPT">Salvar Prescrição e gerar GPT do Receituario
                                </button>
                            </div>
                            <div class="col-sm-4">
                                <button type="submit" class="btn btn-primary btn-block btn-sm"
                                        id="editarPrescricaoEditarOutra"
                                        name="editarPrescricaoEditarOutra">Salvar Prescrição e cadastrar outra
                                </button>
                            </div>
                        </div>
                    </form>

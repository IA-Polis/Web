...
if(isset($_SESSION['PERMISSOES']['excluirPapelUsuario'])){
if(isset($_POST['btnExcluirPapelUsuario']))
{
    $newPapelUsuario = new Classe\PapelUsuario();
    $newPapelUsuario->setCodPapelUsuario($_POST['codPapelUsuario']);
    try
    {
        $saida = "<div class='alert alert-success alert-dismissable'>".$newPapelUsuario->excluir()."</div>";

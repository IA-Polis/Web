...
if(isset($_SESSION['PERMISSOES']['cadastrarPrescricao'])){
    if(isset($_POST['btnCadastrarPrescricao']))
    {
        ...
        )
        {
            try
            {
                $saida = "<div class='alert alert-success alert-dismissable'>".$newPrescricao->incluir()."</div>";
        ...
        else
        {
            ...
            if(!isset($_POST['cboUnidadeMedida']) || empty($_POST['cboUnidadeMedida'])) $saida .= ' UnidadeMedida';

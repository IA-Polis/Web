<?php
	...
	namespace Config {
		class PushNotifications {
			...
			private static $passphrase = 'admnet';
			...
			public static function WP($data, $uri) {
				...
				$response = PushNotifications::useCurl($uri, $sendedheaders, $msg);
			...
			public static function iOS($data, $devicetoken) {
				...
				stream_context_set_option($ctx, 'ssl', 'local_cert', '/var/www/ibeauty/admin/config/ck.pem');
